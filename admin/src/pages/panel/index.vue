        ...
        <div class="le-index--content">
            <div class="flex le-content__top">
                <div class="le-top__store le-panel__card flex flex-direction align-center">
                    <div class="le-store__sign">
                        <img :src="getStore.logo" alt="logo" class="le-top__store--img">
                    ...
                    <div class="flex align-center">
                        ...
                        <span class="le-router--text" module="goods" title="推广" :hide_footer="true" type="text"
                              v-popup.promote="{data: '',promoteType: 'index'}" width="791">推广</span>
                    </div>
                </div>
                    ...
                    <div class="le-router__top flex">
                        <div class="le-panel__card flex le-router__top-left">
                            <div class="flex-sub flex flex-direction align-center justify-center">
                                <span class="le-number" @click="router(0)">{{ store_count.unpaid }}</span>
                                <span class="le-prompt">待付款订单</span>
                            </div>
                            <div class="flex-sub flex flex-direction align-center justify-center">
                                <span class="le-number" @click="router(1)">{{ store_count.unsent }}</span>
                                <span class="le-prompt">待发货订单</span>
                            </div>
                            <div class="flex-sub flex flex-direction align-center justify-center">
                                <span class="le-number" @click="router(2)">{{ store_count.order_after }}</span>
                                <span class="le-prompt">售后订单</span>
                            </div>
                        </div>
                        <div class="le-panel__card le-router__top-right flex">
                            <div class="flex-sub flex flex-direction align-center justify-center">
                                <span class="le-number" @click="router(6)">{{ store_count.user_number }}</span>
                                <span class="le-prompt">总用户数</span>
                            </div>
                            <div class="flex-sub flex flex-direction align-center justify-center">
                                <span class="le-number">￥{{ store_count.income_amount }}</span>
                                <span class="le-prompt">
                                    订单总收入
                                    <el-popover content="过售后订单收入" placement="top" trigger="hover">
                                        <he-icon class="he-annotation" slot="reference"
                                                 type="le-icon-annotation"></he-icon>
                                    </el-popover>
                                </span>
                            </div>
                        </div>
            ...
            <div class="le-content__footer flex">
                <div class="le-table__content le-panel__card flex-sub">
                        ...
                        <el-table-column label="排名" width="55">
                            <template slot-scope="scope">
                                <div class="flex justify-start align-center">
                                    ...
                                    <img v-else-if="((sale_page.current - 1)* sale_page.size) + scope.$index+1  === 1"
                                         src="./image/he-rank-1.png" alt="">
                                    <img v-else-if="((sale_page.current - 1)* sale_page.size) + scope.$index+1  ===2"
                                         src="./image/he-rank-2.png" alt="">
                                    <img v-else-if="((sale_page.current - 1)* sale_page.size) + scope.$index+1  === 3"
                                         src="./image/he-rank-3.png" alt="">
                                </div>
                            </template>
                        </el-table-column>
                    ...
                    <div class="flex justify-end le-table__page">
                        <el-pagination
                            background :current-page="sale_page.current"
                        ...
                        <el-table-column label="排名" width="55">
                            <template slot-scope="scope">
                                <div class="flex justify-start align-center">
                                    ...
                                    <img v-else-if="((buyer_page.current - 1)* buyer_page.size) + scope.$index+1  === 1"
                                         src="./image/he-rank-1.png" alt="">
                                    <img v-else-if="((buyer_page.current - 1)* buyer_page.size) + scope.$index+1  === 2"
                                         src="./image/he-rank-2.png" alt="">
                                    <img v-else-if="((buyer_page.current - 1)* buyer_page.size) + scope.$index+1  === 3"
                                         src="./image/he-rank-3.png" alt="">
                                </div>
                            </template>
                        </el-table-column>
                            ...
                            <template slot-scope="scope">
                                <div class="flex align-center">
                                    ...
                                    <el-popover placement="top" max-width="400" trigger="hover"
                                        ...
                                        <he-icon class="le-icon" slot="reference" size="18px"
            ...
            <div class="le-panel__footer">
                <div class="le-link">
                    <span>官网</span>丨
                    <span>
                        <a href="http://forum.leadshop.vip/" target="_blank">论坛</a>
                    </span>丨
                    <span>文档</span>
                </div>
                <div class="le-copy">{{copyright}}</div>
            </div>
        </div>
    </el-scrollbar>
</template>
...
export default {
    ...
    methods: {
        ...
        getList: function (include, keyword, page, list, callback) {
            let _this = this;
            this.$heshop.search('post', {include: include}, {keyword: keyword}).page(this[page].current, this[page].size).then(function (res) {
