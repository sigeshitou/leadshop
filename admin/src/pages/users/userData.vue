            ...
            <div class="el-row--flex he-info">
                ...
                <div style="margin: 45px 0 0 40px;">
                    <div class="le-item">
                        ...
                        <he-icon class="he-icon" type="le-icon-editor" :title="'修改真实姓名'" v-popup.modifyRealname="detail"
                                 width="360" top="35vh" module="users"></he-icon>
                    </div>
                    <div class="le-item">
                        <span class="le-label">手机号:</span>
                        <span class="le-value">{{ detail.mobile }}</span>
                        <he-icon :title="'修改手机号'" class="he-icon" type="le-icon-editor" v-popup.modifyMobile="detail"
                                 width="360" top="35vh" module="users"></he-icon>
                    </div>
                    <div class="le-item">
                    ...
                    <div class="le-item">
                        ...
                        <span
                            class="le-value">{{ detail.statistical ? detail.statistical.last_visit_time : '' | getTime }}</span>
                    </div>
                </div>
                <div style="margin: 45px 0 0 150px;" class="flex flex-direction justify-start">
                    <div class="le-item">
                        ...
                        <span
                            class="he-value">{{ detail.oauth.type === 'weapp' ? ' 微信小程序' : detail.oauth.type === 'wechat' ? ' 公众号' : ' --' }}</span>
                    </div>
                </div>
            </div>
        </div>
